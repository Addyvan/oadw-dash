...
class CollabCareerMP extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showingLineUserOptin: true,
      showingPieOptStatus: true,
      showingPieOptType: true,
      showingPieOptRefferal: true
    }
  }
  componentDidMount() {
  ...
  render() {
    const { showingLineUserOptin } = this.state;
    const { showingPieOptStatus } = this.state;
    const { showingPieOptType } = this.state;
    const { showingPieOptRefferal } = this.state;
    return (
          ...
          <Col xs = {9} sm={9} md = {9} lg = {9}>
            <Card style = {{height: "512px"}}>
              <CardBody>
                ...
                <Graph title="Number of Users who have Opted Into each Oppurtunity Type" 
                      x={[3619,
                        5343,
                        3988,
                        5266,
